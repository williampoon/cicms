...
class Upload
{
     ...
     * 错误码、错误信息
     */
    const ERR_SERVER_NEED_SECRET_KEY = 50000;
    const ERR_CLIENT_NEED_SECRET_KEY = 50000;
    const ERR_WRONG_SECRET_KEY       = 50000;
    const ERR_NEED_PROJECT           = 50000;
    const ERR_PROJECT_NOT_ALLOW      = 50000;
    ...
    public function setConfig(array $config)
    {
        ...
        if (!empty($config['project']) && is_string($config['project'])) {
            $this->params['project'] = $config['project'];
        }
